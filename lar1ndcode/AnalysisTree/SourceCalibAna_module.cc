////////////////////////////////////////////////////////////////////////
// Class:       SourceCalibAna
// Module Type: analyzer
// File:        SourceCalibAna_module.cc
//
// Generated at Tue May 17 16:31:45 2016 by Jonathan Asaadi using artmod
...
public:
  explicit SourceCalibAna(fhicl::ParameterSet const & p);
  // The destructor generated by the compiler is fine for classes
  // without bare pointers or other resource use.

  // Plugins should not be copied or assigned.
  SourceCalibAna(SourceCalibAna const &) = delete;
  SourceCalibAna(SourceCalibAna &&) = delete;
  SourceCalibAna & operator = (SourceCalibAna const &) = delete;
  SourceCalibAna & operator = (SourceCalibAna &&) = delete;
...
// === Function used to reset all the variables  ===
  ...
  int NTrTrajPts[kMaxPrimaryPart];
...
// ==========================================================================
SourceCalibAna::SourceCalibAna(fhicl::ParameterSet const & pset) :EDAnalyzer(pset)  // ,
...
// ==========================================================================
void SourceCalibAna::reconfigure(fhicl::ParameterSet const & pset)
{
...
void SourceCalibAna::analyze(art::Event const & evt)
{
  // #############################################
  ...
  if(!isdata)
    {
	 ...
	 if(geant_part[i]->Process()==pri){ primary++;}
  ...
  for(size_t i=0; i<tracklist.size();++i)
      ...
      for (int j = 0; j<2; ++j)
	{
	  ...
	  try
		...
		// Don't know why the above doens't work....must come back to....
		trkpitch[i][j] = 0.0045;
	...
	for (size_t h = 0; h < vhit.size(); ++h)
      ...
      // ################################################
      // ### IF MC find true track to hit association ###
      // ################################################
...
void SourceCalibAna::endJob()
{
  // Implementation of optional member function here.
}

void SourceCalibAna::ResetVars()
{
...
DEFINE_ART_MODULE(SourceCalibAna)
