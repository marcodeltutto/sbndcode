...
sub gen_reflectorFoils()
{
  # Set up the output file.                                                                                                          
  $RF = "LAr1-reflectorfoils" . $suffix . ".gdml";
  push (@gdmlFiles, $RF); # Add file to list of GDML fragments                                                                       
  $RF = ">" . $RF;
  open(RF) or die("Could not open file $RF for writing");
  
  print RF <<EOF;
  <?xml version='1.0'?>
  <gdml>
    <solids>
<!-- radius of the PMT = (2.54*4.0*3/6.1) => I add this 2 x this size to the dimensions of the foils  -->
 <box name="ReflectorLayerXY" lunit="cm" x="2*$TPCWidth + $CathodeWidthX" y="$TPCHeight + 2*(2.54*4.0*3/6.1)" z="0.025"/>
 <box name="TPBLayerXY"       lunit="cm" x="2*$TPCWidth + $CathodeWidthX" y="$TPCHeight + 2*(2.54*4.0*3/6.1)" z="0.02844"/>
 <box name="ReflectorLayerXZ" lunit="cm" x="2*$TPCWidth + $CathodeWidthX" y="0.025" z="$TPCLength + 2*(2.54*4.0*3/6.1)"/>
 <box name="TPBLayerXZ"       lunit="cm" x="2*$TPCWidth + $CathodeWidthX" y="0.02844" z="$TPCLength + 2*(2.54*4.0*3/6.1)"/>  
 <!--box name="CathodePlate2" lunit="cm" x="$CathodeWidthX - (0.02844 - 0.025)" y="$CathodeHeightY" z="$CathodeLengthZ"/>
 <box name="TPBLayerCathode" lunit="cm"  x="$CathodeWidthX" y="$CathodeHeightY" z="$CathodeLengthZ"/-->  
 <box name="ReflectorLayerYZ" lunit="cm" x="0.025" y="$CathodeHeightY" z="$CathodeLengthZ"/>
 <box name="TPBLayerYZ" lunit="cm" x="0.02844" y="$CathodeHeightY" z="$CathodeLengthZ"/>

 </solids>      
<structure>      
<volume name="volReflectorLayerXY1">
  <materialref ref="vm2000"/>
  <solidref ref="ReflectorLayerXY"/>
 </volume>
<volume name="volReflectorLayerXY2">
  <materialref ref="vm2000"/>
  <solidref ref="ReflectorLayerXY"/>
 </volume>
<volume name="volReflectorLayerXZ1">
  <materialref ref="vm2000"/>
  <solidref ref="ReflectorLayerXZ"/>
 </volume>
<volume name="volReflectorLayerXZ2">
  <materialref ref="vm2000"/>
  <solidref ref="ReflectorLayerXZ"/>
 </volume>
 <!--volume name="volCathodePlate2">
    <materialref ref="STEEL_STAINLESS_Fe7Cr2Ni"/>
    <solidref ref="CathodePlate2"/>
 </volume-->
<volume name="volReflectorLayerYZ1">
  <materialref ref="vm2000"/>
...
<volume name="volReflectorLayerYZ2">
  ...
  <solidref ref="ReflectorLayerYZ"/>
      ...
      <volume name="volTPBLayerXY1">
       ...
       <physvol>
       <volumeref ref="volReflectorLayerXY1"/>
       <position name="posReflXY1" unit="cm" x="0" y="0" z="0"/>
       </physvol>
     </volume>
     <volume name="volTPBLayerXY2">
       <materialref ref="TPB"/>
       <solidref ref="TPBLayerXY"/>
       <physvol>
       <volumeref ref="volReflectorLayerXY2"/>
       <position name="posReflXY2" unit="cm" x="0" y="0" z="0"/>
       </physvol>
      </volume>
     <volume name="volTPBLayerXZ1">
      <materialref ref="TPB"/>
      <solidref ref="TPBLayerXZ"/>
      <physvol>
      <volumeref ref="volReflectorLayerXZ1"/>
      <position name="posReflXZ1" unit="cm" x="0" y="0" z="0"/>
      </physvol>
     </volume>
     <volume name="volTPBLayerXZ2">
      <materialref ref="TPB"/>
      <solidref ref="TPBLayerXZ"/>
      <physvol>
      <volumeref ref="volReflectorLayerXZ2"/>
      <position name="posReflXZ2" unit="cm" x="0" y="0" z="0"/>
      </physvol>
     </volume>
    <!--volume name="volTPBCathode">
     <materialref ref="TPB"/>
     <solidref ref="TPBLayerCathode"/>
     <physvol>
     <volumeref ref="volCathodePlate2"/>
     <position name="posCathP2" unit="cm" x="0" y="0" z="0"/>
     </physvol>
   </volume-->
    <volume name="volTPBLayerYZ1">
      <materialref ref="TPB"/>
      <solidref ref="TPBLayerYZ"/>
      <physvol>
      <volumeref ref="volReflectorLayerYZ1"/>
...
<solids>
 ...
 <tube name="PMT_Back" rmax="2.54*4.0*3/6.1" z="$pmt_back" deltaphi="360" aunit="deg" lunit="cm"/>
 <tube name="PMT_Stalk" rmax="(1.25*3/6.1*2.54)" z="(3.0*2.54) + 1.25*2.54 - $pmt_back" deltaphi="360" aunit="deg" lunit="cm"/>
EOF
    print PMT <<EOF;
...
EOF
 ...
 <volume name="volPMT">
  ...
  <physvol>
   ...
   <position name="pos_PMT_Stalk" unit="cm" x="0" y="0" z="(3.0 * 2.54)-(5.5 * 2.54) + 1.25*2.54/2 - $pmt_back/2."/>
  </physvol>
...
EOF
 if ( $pmt_back > 0 ) {
  ...
  <physvol>
   ...
   <position name="pos_PMT_Back" unit="cm" x="0" y="0" z="(3.0 * 2.54) + 1.25*2.54/2 - (5.5 * 2.54) - $pmt_back/2+(3.0*2.54)/2 + 1.25*2.54/2"/>
  </physvol>
EOF
 }
 print PMT <<EOF;
...
EOF
 ...
 if ( $reflectorFoils_switch eq "on" ) {
      print CRYOSTAT <<EOF;
     <!-- the last term in the position of the foils (radius of the PMT = (2.54*4.0*3/6.1)) is to completely cover 
