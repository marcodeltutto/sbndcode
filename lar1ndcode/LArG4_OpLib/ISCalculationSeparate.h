...
#include "lar1ndcode/LArG4_OpLib/ISCalculation.h"
...
namespace larg4 {
 ...
 private:
   ...
   double 	   	 fEfield;              ///< value of electric field from LArPropertiesOpLib service  
   double 	   	 fGeVToElectrons;      ///< conversion factor from LArPropertiesOpLib service	  
   ...
   bool   	   	 fScintByParticleType; ///< from LArPropertiesOpLib service			  
