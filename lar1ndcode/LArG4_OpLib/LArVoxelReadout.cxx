...
namespace larg4 {
  ...
  void LArVoxelReadout::EndOfEvent(G4HCofThisEvent*)
  {
    ...
    // get Argon 39 rate from LArG4OpLib parameter
    ...
    if ( step->GetTotalEnergyDeposit() > 0 ){
      ...
      if( !fDontDriftThem ){
        ...
        if (bSingleTPC) {
          ...
          if (!pTouchable) {
            throw cet::exception
              ("lar1ndcode/LArG4_OpLib") << "Untouchable step in LArVoxelReadout::ProcessHits()";
          }
          ...
          if (depth < pTouchable->GetHistoryDepth()) {
            ...
            throw cet::exception
              ("lar1ndcode/LArG4_OpLib") << "No TPC ID found in LArVoxelReadout::ProcessHits()";
          } // if
