...
/// this information is made available to the main LArG4OpLib module.
/// 
...
#ifndef LArG4OpLib_LArVoxelReadout_h
#define LArG4OpLib_LArVoxelReadout_h
...
namespace larg4 {
  ...
  private:
    ...
    // obtained from LArG4Parameters, LArPropertiesOpLib, and DetectorProperties services
    ...
    art::ServiceHandle<sim::LArG4Parameters>  fLgpHandle;  ///< Handle to the LArG4OpLib parameters service
    art::ServiceHandle<util::LArPropertiesOpLib>   fLarpHandle; ///< Handle to the LArPropertiesOpLib parameters service
...
#endif // LArG4OpLib_LArVoxelReadout_h
