...
/// This class implements the LArG4OpLib::UserAction interface in order to
...
#ifndef LArG4OpLib_LARLIGHTENERGYACTION_H
#define LArG4OpLib_LARLIGHTENERGYACTION_H
...
#endif // LArG4OpLib_LARLIGHTENERGYACTION_H
