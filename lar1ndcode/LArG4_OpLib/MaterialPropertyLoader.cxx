...
namespace larg4 {
  ...
  void MaterialPropertyLoader::UpdateGeometry(G4LogicalVolumeStore * lvs)
  {
	...
	if(PropertyPointer) {
	  std::cout<< "defining Titanium optical boundary "<<std::endl;
	  ...
	  std::cout<< "Warning: Titanium surface in the geometry without REFLECTIVITY assigned"<<std::endl;
      }
  ...
  {
    art::ServiceHandle<util::LArPropertiesOpLib>   LarProp;
