...
namespace opdet
{
    class DoubleEndOpDetResponse : public opdet::OpDetResponseInterface {
    public:

        DoubleEndOpDetResponse(fhicl::ParameterSet const& pset, art::ActivityRegistry& reg);
        ~DoubleEndOpDetResponse() throw();
    ...
    }; // class DoubleEndOpDetResponse

    
} //namespace opdet


DECLARE_ART_SERVICE_INTERFACE_IMPL(opdet::DoubleEndOpDetResponse, opdet::OpDetResponseInterface, LEGACY)
