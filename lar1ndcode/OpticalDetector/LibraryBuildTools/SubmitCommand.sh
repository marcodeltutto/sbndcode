...
script=OpticalLibraryBuild_Grid_sbnd.sh
outdir=/pnfs/lbne/scratch/users/ahimmel/OpticalLibraries/OpticalLib_sbnd_doubleend/
fcl=$PWD/sbnd_buildopticallibrary_grid.fcl
