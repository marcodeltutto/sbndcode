...
/*!
 * Title:   SimPhotonCounterOpLib Class
...
namespace opdet{
  ...
  class SimPhotonCounterOpLib{

  public:
    SimPhotonCounterOpLib() {}
    SimPhotonCounterOpLib(size_t s, float t_p1, float t_p2, float t_l1, float t_l2, float min_w=0, float max_w=1e6, float e=1.0);

    SimPhotonCounterOpLib(float t_p1, float t_p2, float t_l1, float t_l2, float min_w, float max_w, const std::vector<float>& eV);
