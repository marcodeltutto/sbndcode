...
// File:        CRTTrackCosmicIdAna_module.cc
//
...
namespace sbnd {
  ...
  class CRTTrackCosmicIdAna : public art::EDAnalyzer {
  public:
    ...
    explicit CRTTrackCosmicIdAna(Parameters const& config);
  ...
  // Constructor
  CRTTrackCosmicIdAna::CRTTrackCosmicIdAna(Parameters const& config)
    : EDAnalyzer(config)
  ...
  void CRTTrackCosmicIdAna::beginJob()
  {
  ...
  void CRTTrackCosmicIdAna::analyze(const art::Event& event)
  {
  ...
  void CRTTrackCosmicIdAna::endJob(){
  
    
  } // CRTTrackCosmicIdAna::endJob()


  void CRTTrackCosmicIdAna::GetPFParticleIdMap(const PFParticleHandle &pfParticleHandle, PFParticleIdMap &pfParticleMap){
