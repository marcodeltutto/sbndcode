...
namespace sbnd {
  ...
  private:
    ...
    std::vector<std::string> cuts{"None","FV","SP","Geo","CC","AC","CT","CH","PT","FM","PN","Tot","Remain"};
    size_t nCuts = cuts.size();

    TH1D* hBeamTime;

    TH1D *hTrueMom[4][13];
    TH1D *hTrueLength[4][13];
    TH1D *hTrueTheta[4][13];
    TH1D *hTruePhi[4][13];

    TH1D *hRecoMom[5][13];
    TH1D *hRecoLength[5][13];
    TH1D *hRecoTheta[5][13];
    TH1D *hRecoPhi[5][13];
...
*/
    ...
    for (PFParticleIdMap::const_iterator it = pfParticleMap.begin(); it != pfParticleMap.end(); ++it){
        ...
        if(particles.find(trueId) != particles.end()){
          ...
          if(std::abs(particles[trueId].PdgCode()) == 13){
            ...
            for(size_t j = 0; j < nCuts; j++){
              ...
              if(j == 0) plot = true;
              if(j == 1){
                cosIdAlg.SetCuts(true, false, false, false, false, false, false, false, false, false);
              ...
              if(j == 2){
                cosIdAlg.SetCuts(false, true, false, false, false, false, false, false, false, false);
                //if(cosIdAlg.CosmicId(tpcTrack, event, fakeTpc0Flashes, fakeTpc1Flashes)) plot = true;
                if(cosIdAlg.CosmicId(tpcTrack, event)) plot = true;
              }
              if(j == 3){
                cosIdAlg.SetCuts(false, false, true, false, false, false, false, false, false, false);
                //if(cosIdAlg.CosmicId(tpcTrack, event, fakeTpc0Flashes, fakeTpc1Flashes)) plot = true;
                if(cosIdAlg.CosmicId(tpcTrack, event)) plot = true;
              }
              if(j == 4){
                cosIdAlg.SetCuts(false, false, false, true, false, false, false, false, false, false);
                //if(cosIdAlg.CosmicId(tpcTrack, event, fakeTpc0Flashes, fakeTpc1Flashes)) plot = true;
                if(cosIdAlg.CosmicId(tpcTrack, event)) plot = true;
              }
              if(j == 5){
                cosIdAlg.SetCuts(false, false, false, false, true, false, false, false, false, false);
                //if(cosIdAlg.CosmicId(tpcTrack, event, fakeTpc0Flashes, fakeTpc1Flashes)) plot = true;
                if(cosIdAlg.CosmicId(tpcTrack, event)) plot = true;
              }
              if(j == 6){
                cosIdAlg.SetCuts(false, false, false, false, false, true, false, false, false, false);
                //if(cosIdAlg.CosmicId(tpcTrack, event, fakeTpc0Flashes, fakeTpc1Flashes)) plot = true;
                if(cosIdAlg.CosmicId(tpcTrack, event)) plot = true;
              }
              if(j == 7){
                cosIdAlg.SetCuts(false, false, false, false, false, false, true, false, false, false);
                //if(cosIdAlg.CosmicId(tpcTrack, event, fakeTpc0Flashes, fakeTpc1Flashes)) plot = true;
                if(cosIdAlg.CosmicId(tpcTrack, event)) plot = true;
              }
              if(j == 8){
                cosIdAlg.SetCuts(false, false, false, false, false, false, false, true, false, false);
                //if(cosIdAlg.CosmicId(tpcTrack, event, fakeTpc0Flashes, fakeTpc1Flashes)) plot = true;
                if(cosIdAlg.CosmicId(tpcTrack, event)) plot = true;
              }
              if(j == 9){
                cosIdAlg.SetCuts(false, false, false, false, false, false, false, false, true, false);
                //if(cosIdAlg.CosmicId(tpcTrack, event, fakeTpc0Flashes, fakeTpc1Flashes)) plot = true;
                if(cosIdAlg.CosmicId(tpcTrack, event)) plot = true;
              }
              if(j == 10){
                cosIdAlg.SetCuts(false, false, false, false, false, false, false, false, false, true);
                //if(cosIdAlg.CosmicId(tpcTrack, event, fakeTpc0Flashes, fakeTpc1Flashes)) plot = true;
                if(cosIdAlg.CosmicId(tpcTrack, event)) plot = true;
              }
              ...
              if(j == 12 && !cosIdAlg.CosmicId(tpcTrack, event)) plot = true;
              if(!plot) continue;
      ...
      for(size_t j = 0; j < nCuts; j++){
        ...
        //if(j == 11 && !cosIdAlg.CosmicId(*pParticle, pfParticleMap, event, fakeTpc0Flashes, fakeTpc1Flashes)){ 
        if(j == 12 && !cosIdAlg.CosmicId(*pParticle, pfParticleMap, event)){ 
          plot = true;
        }
        if(!plot) continue;
