#include "StoppingParticleCosmicTagAlg.h"

namespace sbnd{

StoppingParticleCosmicTagAlg::StoppingParticleCosmicTagAlg(const Config& config){
...
StoppingParticleCosmicTagAlg::StoppingParticleCosmicTagAlg(){
...
bool StoppingParticleCosmicTagAlg::StoppingEnd(geo::Point_t end, std::vector<art::Ptr<anab::Calorimetry>> calos){
