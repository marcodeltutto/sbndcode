...
class sbnd::HecAnalyzer : public art::EDAnalyzer {
public:
...
sbnd::HecAnalyzer::HecAnalyzer(fhicl::ParameterSet const & p)
  :
  EDAnalyzer(p)  // ,
 // More initializers here.
{
  std::cout<<std::endl;
  std::cout<<"--Hec: Calling sbnd::HecAnalyzer::HecAnalyzer"<<std::endl;
  std::cout<<std::endl;
...
void sbnd::HecAnalyzer::analyze(art::Event const & e)
{
  ...
  std::cout<<std::endl;
  std::cout<<"--Hec: Calling sbnd::HecAnalyzer::analyze:  Run="
...
void sbnd::HecAnalyzer::beginJob()
{  
  art::ServiceHandle<art::TFileService> tfs;
  
  // Implementation of optional member function here.
  std::cout<<std::endl;
  std::cout<<"--Hec: Calling sbnd::HecAnalyzer::beginJob()"<<std::endl;
  std::cout<<std::endl;
...
void sbnd::HecAnalyzer::reconfigure(fhicl::ParameterSet const & p)
{
  // Implementation of optional member function here.
  std::cout<<std::endl;
  std::cout<<"--Hec: Calling sbnd::HecAnalyzer::reconfigure"<<std::endl;
  std::cout<<std::endl;  
  
  fG4ModuleLabel        = p.get< std::string >("LArG4ModuleLabel");
}

DEFINE_ART_MODULE(sbnd::HecAnalyzer)
