///////////////////////////////////////////////////////////////////////
///
/// \file   SignalShapingServiceVST.h
///
...
namespace util {
  class SignalShapingServiceVST {
  public:

    // Constructor, destructor.

    SignalShapingServiceVST(const fhicl::ParameterSet& pset,
				   art::ActivityRegistry& reg);
    ~SignalShapingServiceVST();
  ...
  private:
    ...
    void init() const{const_cast<SignalShapingServiceVST*>(this)->init();}
    void init();
...
//----------------------------------------------------------------------
// Do convolution.
template <class T> inline void util::SignalShapingServiceVST::Convolute(unsigned int channel, std::vector<T>& func) const
{
...
//----------------------------------------------------------------------
// Do deconvolution.
template <class T> inline void util::SignalShapingServiceVST::Deconvolute(unsigned int channel, std::vector<T>& func) const
{
...
DECLARE_ART_SERVICE(util::SignalShapingServiceVST, LEGACY)
#endif
