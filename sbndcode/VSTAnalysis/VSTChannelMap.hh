...
public:
  ...
  unsigned Channel2Wire(daqAnalysis::ReadoutChannel channel) const;
  unsigned Wire2Channel(unsigned wire_no) const;
  daqAnalysis::ReadoutChannel Ind2ReadoutChannel(unsigned channel_no) const;
...
DECLARE_ART_SERVICE(daqAnalysis::VSTChannelMap, LEGACY)
